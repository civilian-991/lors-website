...
export default function Hero() {
  return (
    ...
    >
      {/* Animated Background Blobs - Navy & Red brand colors */}
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-20 -left-20 w-96 h-96 rounded-full animate-blob"
          style={{
            background: "radial-gradient(circle, rgba(14,47,113,0.06) 0%, rgba(14,47,113,0.02) 100%)",
            animationDelay: "0s"
          }}
        />
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(198,0,15,0.06) 0%, rgba(103,0,8,0.03) 100%)",
            animationDelay: "2s"
          }}
        />
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(14,47,113,0.04) 0%, transparent 70%)",
            animationDelay: "4s"
          }}
        />
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(198,0,15,0.04) 0%, transparent 70%)",
            animationDelay: "1s"
          }}
        />
      </div>

      {/* Decorative Circles - Navy & Red accents */}
      <div className="absolute top-32 right-1/4 w-4 h-4 rounded-full animate-float opacity-70" style={{ background: "#C6000F" }} />
      <div className="absolute top-1/2 left-16 w-6 h-6 rounded-full animate-float-reverse opacity-50" style={{ background: "#0E2F71" }} />
      <div className="absolute bottom-40 right-20 w-3 h-3 rounded-full animate-float-delay opacity-60" style={{ background: "#670008" }} />
      <div className="absolute top-1/3 right-10 w-5 h-5 rounded-full animate-float opacity-40" style={{ background: "#12357A" }} />
      <div className="absolute bottom-1/3 left-1/4 w-2 h-2 rounded-full animate-pulse opacity-60" style={{ background: "#C6000F" }} />

      {/* Subtle grid pattern */}
      <div
        className="absolute inset-0 opacity-[0.015]"
        style={{
          backgroundImage: `linear-gradient(#0E2F71 1px, transparent 1px), linear-gradient(90deg, #0E2F71 1px, transparent 1px)`,
        ...
        <div className="flex-1 text-center lg:text-left">
          <div className="animate-slide-up opacity-0" style={{ animationDelay: "0.2s", animationFillMode: "forwards" }}>
            <span
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(14,47,113,0.3)"
              }}
            >
          ...
          >
            <a
              ...
              style={{
                background: "linear-gradient(135deg, #0E2F71 0%, #12357A 100%)",
                boxShadow: "0 8px 30px rgba(14,47,113,0.35)"
              }}
            >
        ...
        <div className="flex-1 relative">
          ...
          >
            ...
            <div
              ...
              style={{
                background: "radial-gradient(circle, rgba(198,0,15,0.12) 0%, rgba(14,47,113,0.06) 50%, transparent 70%)",
                transform: "scale(1.6)",
              }}
            />
            ...
            <div
              ...
              style={{
                background: "radial-gradient(circle at 70% 30%, rgba(14,47,113,0.08) 0%, transparent 50%)",
                transform: "scale(1.3)",
              }}
            />
            ...
            <div className="absolute -top-8 -right-4 w-28 h-28 animate-float-reverse">
              <div
                ...
                style={{
                  boxShadow: "0 10px 40px rgba(14,47,113,0.12), inset 0 0 0 1px rgba(14,47,113,0.1)"
                }}
              >
                <Image
            ...
            <div className="absolute -bottom-4 -left-8 w-24 h-24 animate-float-delay">
              <div
                className="w-full h-full rounded-2xl shadow-2xl flex items-center justify-center p-2 overflow-hidden bg-white"
                style={{
                  boxShadow: "0 10px 40px rgba(198,0,15,0.12), inset 0 0 0 1px rgba(198,0,15,0.1)"
                }}
              >
                <Image
            ...
            <div className="absolute top-1/2 -right-12 w-20 h-20 animate-float">
              <div
                ...
                style={{
                  boxShadow: "0 8px 30px rgba(14,47,113,0.1), inset 0 0 0 1px rgba(14,47,113,0.08)"
                }}
              >
                <Image
            ...
            {/* Decorative ring - Navy */}
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] rounded-full border border-dashed animate-spin-slow opacity-15"
              style={{ borderColor: "#0E2F71" }}
            />
          </div>
        </div>
      </div>

      {/* Scroll Indicator - Navy */}
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
        <div
          className="w-10 h-14 rounded-full flex items-start justify-center p-2"
          style={{
            border: "2px solid #0E2F71",
            opacity: 0.3
          }}
        >
          <div
            className="w-2 h-3 rounded-full animate-pulse"
            style={{ background: "#0E2F71" }}
          />
        </div>
      </div>
