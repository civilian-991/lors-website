...
const products: Product[] = [
  ...
  { id: "ginger-nuts", name: "Ginger Nuts", image: "/images/products/ginger-nuts.png", category: "Biscuits", description: "Crunchy ginger-flavored biscuits with a spicy kick", color: "#8B4513" },
  ...
  { id: "milky", name: "Milky", image: "/images/products/milky.png", category: "Biscuits", description: "Creamy milk-flavored biscuits", color: "#FAFAFA" },
  ...
  { id: "glucose", name: "Glucose", image: "/images/products/glucose.png", category: "Biscuits", description: "Energy-boosting glucose biscuits", color: "#FFA500" },
  { id: "abu-cracker", name: "Abu Cracker", image: "/images/products/abu-cracker.png", category: "Crackers", description: "Light and crispy savory crackers", color: "#DEB887" },
  { id: "mr-cracker", name: "Mr Cracker", image: "/images/products/mr-cracker.png", category: "Crackers", description: "Premium crackers for every occasion", color: "#D2691E" },
  ...
  { id: "power-cake", name: "Power Cake", image: "/images/products/power-cake.png", category: "Cakes", description: "Energy-packed cake for active lifestyles", color: "#FF6B35" },
  { id: "spongy", name: "Spongy", image: "/images/products/spongy.png", category: "Cakes", description: "Light and fluffy sponge cakes", color: "#FFE4B5" },
  { id: "two-friends", name: "Two Friends", image: "/images/products/two-friends.png", category: "Biscuits", description: "Two delicious biscuits, better together", color: "#8B4513" },
  ...
  { id: "yum-yum", name: "Yum Yum", image: "/images/products/yum-yum.png", category: "Snacks", description: "Irresistible snacks that make you say yum!", color: "#FF4500" },
];
...
export default function Products() {
  ...
  return (
    ...
    >
              ...
              style={{
                ...
                background:
                  activeCategory === category
                    ...
                    : "white",
                color: activeCategory === category ? "white" : "#4A2C2A",
                boxShadow:
                  activeCategory === category
                    ? "0 4px 20px rgba(198,0,15,0.3)"
            ...
            >
              ...
              >
                ...
                <div className="p-5 text-center">
                  ...
                  <p
                    className="text-sm leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    style={{
                      fontFamily: "'Nunito', sans-serif",
                      color: "#4A2C2A",
                      opacity: 0.7,
      ...
      {/* Decorative Elements */}
      <div className="absolute top-20 left-10 w-20 h-20 rounded-full bg-[#C6000F]/5 animate-float" />
      <div className="absolute bottom-40 right-10 w-32 h-32 rounded-full bg-[#D4A574]/10 animate-float-reverse" />
    </section>
  );
}
